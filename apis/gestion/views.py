...
def creaunatrama(dni):
    ...
    if len(dni)==7:
        ...
        if OrigBaseC01.objects.filter(dni=dnifinal).count() == 0:
...
def creaunatramadependiente(dni,dni_dependiente,nombre,sexo,dependientes,reldependencia,fecha_nacimiento):
        ...
        for rx in range(sh.nrows):
            ...
            for col in range(sh.ncols):
                ...
                if rx > 1:
                    ...
                    if col == 14:
                        ...
                        reldependencia = str(sh.row(rx)[col])

                    if col == 15:

                        sexo = str(sh.row(rx)[col])

                    if col == 18:

                        f = str(sh.row(rx)[col]).split(':u')[0]
            ...
            if dni:
                ...
                if int(len(nombre))>10:
                    ...
                    fecha_nacimiento=str(dt)

                    nombre = nombre.replace("u'","").replace("'","")

                    sexo = str(sexo).split(":u'")[1].replace("'","")
                    ...
                    reldependencia = str(reldependencia).split(":u'")[1].replace("'","")
                    ...
                    trama = trama + creaunatramadependiente(dni,dni_dependiente,nombre,sexo,dependientes,reldependencia,fecha_nacimiento)+chr(13) + chr(10)
